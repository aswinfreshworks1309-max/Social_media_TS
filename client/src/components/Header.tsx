    ...
    <header className="flex sticky top-0 z-50 justify-between border-b border-theme-border h-[80px] items-center bg-theme-bg/80 backdrop-blur-md">
      <div className="flex gap-12 items-center">
        <h1
          ...
          className=" ml-8 text-3xl font-bold text-theme-accent cursor-pointer tracking-tight"
        >
          ConnectHub
        </h1>
        <div className="relative hidden md:block">
          ...
          />
          <Search
            className="absolute top-2.5 left-3 text-theme-text-muted"
            size={18}
          />
      ...
      <div className="flex gap-6 items-center">
        <Link
          to="/notification"
          className="flex relative cursor-pointer group p-2 rounded-full hover:bg-theme-accent/10 transition"
        >
          <Bell
            size={24}
        ...
        >
          <div className="text-right hidden sm:block">
            ...
            <p className="text-[10px] text-theme-text-muted uppercase tracking-tighter">
              Member
            </p>
          </div>
