          ...
          <div className="max-w-5xl mx-auto px-6 py-8">
              ...
              <div className="flex-1">
                ...
                <div className="flex gap-12 mb-6">
                  <div className="text-center cursor-pointer hover:scale-105 transition-transform">
                    ...
                    <p className="text-theme-text-muted text-sm uppercase tracking-wider">
                      Posts
                    </p>
                  </div>
                  <div
            ...
            <div className="border-t border-gray-700 pt-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pb-12">
                {(galleryTab === "posts" ? stats.posts : savedPosts).length >
                0 ? (
                  (galleryTab === "posts" ? stats.posts : savedPosts).map(
                    (post: PostItem, i: number) => (
                      <div
                        key={i}
                        className="flex flex-col bg-theme-card/40 rounded-2xl border border-theme-border overflow-hidden hover:border-theme-accent transition-all duration-300 shadow-lg group"
                      >
                        ...
                        <div className="p-4 flex flex-col gap-3">
                          {post.caption && (
                            <p className="text-[13px] text-gray-200 line-clamp-2 leading-relaxed h-[40px]">
                              {post.caption}
                            </p>
                          )}
